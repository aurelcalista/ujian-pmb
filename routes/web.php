...
Route::get('/student/blocked', [StudentController::class, 'blocked']);
...
Route::middleware([\App\Http\Middleware\AdminAuth::class])->group(function () {
    ...
    Route::get('/admin/exams/{id}', [AdminController::class, 'showExam']);
    ...
    Route::delete('/admin/sessions/{id}', [AdminController::class, 'destroySession']);
    Route::post('/admin/sessions/{id}/unblock', [AdminController::class, 'unblockSession']);
    ...
    Route::get('/admin/study-programs', [AdminController::class, 'studyPrograms']);
    Route::post('/admin/study-programs', [AdminController::class, 'storeStudyProgram']);
